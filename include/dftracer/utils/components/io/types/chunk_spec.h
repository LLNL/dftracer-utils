#ifndef DFTRACER_UTILS_COMPONENTS_IO_TYPES_CHUNK_SPEC_H
#define DFTRACER_UTILS_COMPONENTS_IO_TYPES_CHUNK_SPEC_H
...
namespace std {
template <>
struct hash<dftracer::utils::components::io::ChunkSpec> {
    std::size_t operator()(
        const dftracer::utils::components::io::ChunkSpec& spec) const noexcept {
...
#endif  // DFTRACER_UTILS_COMPONENTS_IO_TYPES_CHUNK_SPEC_H
