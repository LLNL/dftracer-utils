#ifndef DFTRACER_UTILS_COMPONENTS_IO_LINES_LINE_RANGE_H
#define DFTRACER_UTILS_COMPONENTS_IO_LINES_LINE_RANGE_H
...
class LineRange {
   ...
   public:
    ...
    static LineRange from_indexed_file(
        std::shared_ptr<dftracer::utils::Reader> reader, std::size_t start_line,
        std::size_t end_line) {
        return LineRange(
            sources::IndexedFileLineIterator(reader, start_line, end_line));
    }
...
#endif  // DFTRACER_UTILS_COMPONENTS_IO_LINES_LINE_RANGE_H
